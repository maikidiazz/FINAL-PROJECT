...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-06-2026 a las 17:32:34
...
CREATE TABLE `autobuses` (
  `ID_Ruta` int(50) NOT NULL,
  `Camion` varchar(50) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
...
--
ALTER TABLE `autobuses`
  MODIFY `ID_Ruta` int(50) NOT NULL AUTO_INCREMENT;
COMMIT;
